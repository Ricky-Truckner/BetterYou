...
let tabItems: [TabBar] = [
  .init(iconName: "magnifyingglass", destinationView: AnyView(TrackerView()), index: 0),
  .init(iconName: "house", destinationView: AnyView(HomeView()), index: 1),
  .init(iconName: "person", destinationView: AnyView(ProfileView()), index: 2),
]
